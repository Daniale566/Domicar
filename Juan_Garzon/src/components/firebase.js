...
export const saveAppointment = (type_of_service, appoint_hour, dir, num, description) => {
    addDoc(collection(db, 'appointments'), {type_of_service, appoint_hour, dir, num, description});
}
